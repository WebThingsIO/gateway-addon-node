...
class Adapter {
   ...
   * @param {Object?} device - Device the prompt is associated with (optional)
   */
  sendPairingPrompt(prompt, device = null) {
    this.manager.sendPairingPrompt(this, prompt, device);
  }
