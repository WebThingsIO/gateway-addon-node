...
class Database {
  ...
  /**
   * Load the configured localization language from the database.
   *
   * @returns Promise which resolves to the configured language string.
   */
  getLocalizationLanguage() {
    ...
    const key = 'localization.language';
