...
class Device {
  ...
  requestAction(actionId, actionName, input) {
    return new Promise((resolve, reject) => {
      ...
      const action = this.createAction(actionId, actionName, input);
  ...
  /**
   * @method createAction
   * @returns an instance of subclass which is inherited Action class.
   */
  createAction(_actionId, _actionName, _input) {
    return new Action(_actionId, this, _actionName, _input);
  }
